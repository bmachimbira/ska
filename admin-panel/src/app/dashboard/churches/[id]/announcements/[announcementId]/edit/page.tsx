...
export default function EditAnnouncementPage() {
  ...
  const fetchAnnouncement = async () => {
    try {
      ...
      const data = await apiClient.get<any>(`/admin/churches/${churchId}/announcements/${announcementId}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const apiClient = createApiClient(session.accessToken);
      await apiClient.put(`/admin/churches/${churchId}/announcements/${announcementId}`, formData);
      router.push(`/dashboard/churches/${churchId}/announcements/${announcementId}`);
    } catch (err) {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <Link
          href={`/dashboard/churches/${churchId}/announcements/${announcementId}`}
