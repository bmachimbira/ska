...
const permissions: Record<Role, Permission[]> = {
  ...
  editor: [
    ...
    { resource: 'causes', action: 'create' },
    { resource: 'causes', action: 'read' },
    { resource: 'causes', action: 'update' },
    { resource: 'announcements', action: 'create' },
    { resource: 'announcements', action: 'read' },
    { resource: 'announcements', action: 'update' },
    { resource: 'churches', action: 'read' },
    { resource: 'churches', action: 'update' },
  ...
  super_admin: [
    ...
    { resource: 'causes', action: 'read' },
    { resource: 'causes', action: 'update' },
    { resource: 'causes', action: 'delete' },
    { resource: 'announcements', action: 'create' },
    { resource: 'announcements', action: 'read' },
    { resource: 'announcements', action: 'update' },
    { resource: 'announcements', action: 'delete' },
    { resource: 'churches', action: 'create' },
    { resource: 'churches', action: 'read' },
    { resource: 'churches', action: 'update' },
    { resource: 'churches', action: 'delete' },
    { resource: 'devotionals', action: 'create' },
    { resource: 'devotionals', action: 'read' },
    { resource: 'devotionals', action: 'update' },
...
export function canAccessRoute(role: Role, path: string): boolean {
  ...
  const routePermissions: Record<string, { resource: string; action: 'read' | 'create' | 'update' | 'delete' }> = {
    ...
    '/dashboard/series': { resource: 'series', action: 'read' },
    '/dashboard/series/new': { resource: 'series', action: 'create' },
    '/dashboard/series/edit': { resource: 'series', action: 'update' },
    ...
    '/dashboard/events': { resource: 'events', action: 'read' },
    '/dashboard/events/new': { resource: 'events', action: 'create' },
    '/dashboard/events/edit': { resource: 'events', action: 'update' },
    '/dashboard/causes': { resource: 'causes', action: 'read' },
    '/dashboard/causes/new': { resource: 'causes', action: 'create' },
    '/dashboard/causes/edit': { resource: 'causes', action: 'update' },
    '/dashboard/announcements': { resource: 'announcements', action: 'read' },
    '/dashboard/announcements/new': { resource: 'announcements', action: 'create' },
    '/dashboard/announcements/edit': { resource: 'announcements', action: 'update' },
