          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-center">
            <nav className="flex items-center gap-8">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <Link href="/sermons" className="block px-4 py-2 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600">
                    Sermons
                  </Link>
                  <Link href="/devotionals/today" className="block px-4 py-2 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600">
                    Devotionals
                  </Link>
                  <Link href="/sabbath-school" className="block px-4 py-2 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600">
                    Sabbath School
                  </Link>
                </div>
              </div>
                ...
                {shareOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-md p-4">
                    <div className="grid grid-cols-3 gap-3">
                      <a href="#" className="flex items-center justify-center p-2 text-primary-600 hover:bg-primary-50 rounded">
        ...
        {searchOpen && (
          <div className="hidden lg:block pb-4">
            <div className="flex items-center bg-gray-100 rounded-md overflow-hidden">
              ...
              />
              <button className="px-4 py-2 bg-primary-600 text-white hover:bg-primary-700">
                <Search className="h-5 w-5" />
              </button>
            </div>
          </div>
